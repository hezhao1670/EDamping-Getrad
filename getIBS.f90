...
!-------------------------------------------------------------------------------------------------
!same as the RD()
	REAL FUNCTION RSD(XX,YY,ZZ)	
	IMPLICIT NONE
	REAL C1,C2,C3,C4,C5,C6
	REAL XX,YY,ZZ,XT,YT,ZT,DETX,DETY,DETZ,ERRTOL
	REAL SUM,FAC,EPSLON,EA,EB,EC,ED,EE
	REAL SQRTX,SQRTY,SQRTZ,ALAMB,AVE,RD1,RD2
